...
public class InputView {
    ...
    private final static String INPUT_MORE_PRODUCT_AND_COUNT = "현재 %s은(는) %d개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)";
    ...
    public String getMoreProductAndCount(String product, int count) {
        System.out.printf(INPUT_MORE_PRODUCT_AND_COUNT + "%n", product, count);
        return Console.readLine();
    }
